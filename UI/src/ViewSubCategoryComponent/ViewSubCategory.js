            ...
            <div class="row g-5">
                ...
                <br/>
                 <ul>
                  {
                    cList.map((row)=>(
                      <li><Link to={"/viewcategory/viewsubcategory/"+(row.catnm)}>{row.catnm}</Link></li>
                    ))
                  }
                  ...
                  <div class="col-lg-8">
                    <div class="section-title position-relative pb-3 mb-5">
                        ...
                        <h1 class="mb-0">Auction List == {params.catnm}</h1>
                               ...
                               scList.map((row)=>(
                                  <div class="catpart">
                                   <Link to={"/viewproduct/" + (row.catnm) + "/" + (row.subcatnm)} >
                                    <br/>
                                      <br/>
                                  <img src={"../../assets/uploads/subcaticons/"+(row.subcaticonnm)} height="100" width="150"></img>
                                  <br/>
                                  <b>{row.subcatnm}</b>
                                  </Link>
                                  </div> 
